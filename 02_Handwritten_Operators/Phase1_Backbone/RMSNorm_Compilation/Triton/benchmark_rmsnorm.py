# RMSNorm 性能 Benchmark——对比四种实现在不同特征维度下的显存带宽吞吐量
#
# 四位参赛选手：
#   1. torch_native  — PyTorch 官方 F.rms_norm (C++/CUDA 融合算子)
#   2. torch_compile — torch.compile 自动图融合
#   3. my_torch      — 纯 PyTorch 手写 MyRMSNorm (Eager Mode)
#   4. triton        — 手写 Triton 融合 Kernel
#
# 使用 triton.testing.perf_report 自动生成性能图表
